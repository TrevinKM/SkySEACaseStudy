export const destinationData = [
    ...
    },
    {
        "id": 6,
        "arrivaliatacode": "MAD",
        "destination_info": "Fly into the cosmopolitan capital Madrid and explore the iconic Prado Museum before heading west to explore the medieval hill towns of Careers, a UNESCO World Heritage Site, which you will recognise as King’s Landing and Trujillo.\n",
        "name": "Caceres",
        "sky_show": "House of the Dragon"
    },
    {
        "id": 7,
        "arrivaliatacode": "ICN",
        "destination_info": "Zoom through Seoul on the subway, stopping off at palaces, parks and skyscrapers. Try the celebrated KFC - that’s Korean Fried Chicken - or delicious kimchi and bibimbap. Seoul has got something for everyone.",
        "name": "Seoul",
        "sky_show": "Money Heist Korea"
    },
    {
        "id": 8,
        "arrivaliatacode": "YYZ",
